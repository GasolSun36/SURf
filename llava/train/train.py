...
def preprocess(
    ...
    if conversation_lib.default_conversation.version.startswith("v1") or conversation_lib.default_conversation.version=="retrieval":
...
class LazySupervisedDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        if 'image' in self.list_data_dict[i]:
            ...
            # image does not exist in the data, but the model is multimodal - sharegpt
